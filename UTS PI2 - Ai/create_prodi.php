...
<body>
  ...
  <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
	...
	<h1 align="center">Tambah Data Prodi</h1>
	<a class="btn btn-sm btn-warning" href="tblprodi.php">Kembali</a>
	<br><br>
	<form align="center" action="Proses.php" method="post"> <strong>
		...
		<br>
		<input class="form-control" type="text" name="nama_prodi"> </strong>
		<br>
		<button class="btn btn btn-danger" type="reset">Reset</button>
		<button class="btn btn btn-info" type="submit" name="submit_prodi">Submit</button>
